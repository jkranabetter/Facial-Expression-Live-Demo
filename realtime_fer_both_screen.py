...
while (True):
    ...
    for (x,y,w,h) in faces:
        ...
        # text on image
        cv2.putText(img, svm_emotion, (x + 6, y - 6), font, 1.0, (255, 255, 255), 1)
        cv2.putText(img, neural_emotion, (x + 6 , y - 6 + image_height), font, 1.0, (255, 255, 255), 1)
        cv2.putText(img, 'Support Vector', (0, 25), font, 1.0, (255, 255, 255), 1)
        cv2.putText(img, 'Neural Network', (0, image_height + 25), font, 1.0, (255, 255, 255), 1)
    cv2.imshow('FER',img)
    cv2.waitKey(25)
